...
public sealed record RagRequest(string? Query, int? TopK = null, int? MaxContextTokens = null, int? MaxContextItems = null, float MinimumHybridScore = 0, IReadOnlyCollection<KernelOS.Core.ChatMessage>? History = null);
