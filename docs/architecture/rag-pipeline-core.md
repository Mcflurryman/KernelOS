...
Actualmente el chat configurado es local con Ollama, por lo que el contexto se procesa localmente. Un futuro `IChatModel` remoto constituirá una frontera de privacidad y requerirá configuración y política explícitas. No hay historial conversacional, endpoint ni Kai Agent.
