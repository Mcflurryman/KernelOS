...
Document Readers es una frontera arquitectónica diseñada, aún no implementada: recibirá referencias autorizadas de Filesystem y producirá `RawDocument` para Knowledge futuro, sin interpretar instrucciones como órdenes ni acceder a rutas arbitrarias.
