...
La superficie de confirmación conserva un snapshot pendiente y crea la aprobación antes de invocar posteriormente al executor; confirmar nunca ejecuta por sí solo.
